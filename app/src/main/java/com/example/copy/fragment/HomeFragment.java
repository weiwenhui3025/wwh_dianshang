...
import com.example.copy.adapter.ZtAdapter;
import com.example.copy.adapter.HomeAdapter;
import com.example.copy.adapter.JjAdapter;
import com.example.copy.adapter.JxAdapter;
import com.example.copy.adapter.RqAdapter;
import com.example.copy.adapter.XpAdapter;
...
public class HomeFragment extends BaseFragment<HomeContract.View, HomeContract.Presenter> implements HomeContract.View {
    ...
    protected void initView(View view) {
        ...
        ccAdapter = new ZtAdapter(listBeans);
